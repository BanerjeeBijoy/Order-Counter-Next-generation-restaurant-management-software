...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, category_Id, price, image) VALUES('$name', '$category', '$price', '$image')") or die('query failed');
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <h3>add food</h3>
      <input type="text" name="name" class="box" placeholder="enter item name" required>
      ...
      <input type="submit" value="add item" name="add_product" class="btn">
   </form>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <img src="uploaded_img/<?php echo $fetch_products['image']; ?>" alt="" width ="230px" height="100px">
         <div class="name"><?php echo $fetch_products['name']; ?></div>
         <div class="price">Rs<?php echo $fetch_products['price']; ?>/-</div>
         <div class="category"><?= $fetch_products['category_Id']; ?></div>
...
<section class="edit-product-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="update_name" value="<?php echo $fetch_update['name']; ?>" class="box" required placeholder="enter item name">
